...
public class DigestMessage {
    ...
    private String keyForDeduplicate;
    ...
    public void setKeyForDeduplicate(String keyForDeduplicate) {
        this.keyForDeduplicate = keyForDeduplicate;
    }

    public String getKeyForDeduplicate() {
        return keyForDeduplicate;
    }
